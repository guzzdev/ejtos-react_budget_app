        ...
        case 'SUBSTRACT_EXPENSE':
            ...
            const updatedExpenses = state.expenses.map((expense) => {
                if (expense.name === action.payload.name) {
                    const updatedCost = expense.cost - action.payload.cost;
                    totalExpense += updatedCost > 0 ? updatedCost : 0;
                    return {
                        ...expense,
                        cost: updatedCost > 0 ? updatedCost : 0,
                    };
                } else {
...
const initialState = {
    ...
    expenses: [
        ...
        { id: "Finance", name: "Finance", cost: 500 },
        { id: "Sales", name: "Sales", cost: 200 },
